...
library(GenSA)
lower_bounds <- c(0, 0)
upper_bounds <- c(1000, 1000)

alpha_start <- 1  # Replace with a suitable starting value
beta_start <- 1   # Replace with a suitable starting value

result_alternative_GenSA <- GenSA(par = c(alpha_start, beta_start), fn = likelihood_function, lower = lower_bounds, upper = upper_bounds, y = y, N = N)
