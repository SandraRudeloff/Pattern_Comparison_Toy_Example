...
```{r cars}
population_data <- pd$read_pickle(paste("C:\\Users\\srude\\Documents\\Pattern Comparison Project\\Toy Example\\Diffusion Model\\Outputs\\Population\\population_", as.character(scenario), ".pkl", sep=""))
```
```{r}
population_data
```
